...
data class MovieReservation(
    ...
    @Contextual @ColumnInfo(name = "screen_date_time") val screenDateTime: LocalDateTime,
    @ColumnInfo(name = "head_count") val headCount: Int,
    @Contextual @ColumnInfo(name = "cancel_dead_line") val cancelDeadLine: Duration = 15.minutes,
